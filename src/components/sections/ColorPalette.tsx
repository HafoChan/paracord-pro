...
export function ColorPalette() {
  ...
  return (
    <section className="py-12 bg-gradient-to-br from-slate-50 via-white to-accent-50/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-16">
        ...
        <div className="max-w-6xl mx-auto">
              ...
              <div className="flex items-center gap-4 text-left flex-1">
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-sm md:text-base">
                    Khám phá bảng màu phong phú với hệ thống phân loại khoa học
                  </p>
                </div>
              </div>
          ...
          >
            <div className="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden p-6 md:p-8">
              ...
              <div className="grid lg:grid-cols-3 gap-8 mb-8">
                ...
                <div className="lg:col-span-2">
                  {displayColors ? (
                    ...
                    <div className="space-y-10">
                      {Object.entries(COLOR_CATEGORIES).map(([key, category]) => (
                        <div key={key} className="bg-slate-50 rounded-2xl p-6 shadow-md border border-slate-100">
                ...
                <div className="lg:col-span-1">
                  <div className="sticky top-8">
                    <div className="bg-slate-50 rounded-2xl shadow-lg border-2 border-slate-200 overflow-hidden">
                      {selectedColor ? (
                        <>
                          <div
              ...
              {/* Bottom CTA */}
              <div className="bg-gradient-to-r from-accent-600 to-primary-600 rounded-3xl p-8 md:p-12 text-center text-white shadow-2xl mt-8">
        ...
        {/* Bottom CTA - Always visible when collapsed */}
        {!isExpanded && (
          <div className="bg-gradient-to-r from-accent-600 to-primary-600 rounded-3xl p-8 md:p-12 text-center text-white shadow-2xl mt-6">
            <div className="max-w-3xl mx-auto">
              <h3 className="text-2xl md:text-3xl font-bold mb-4">Cần màu đặc biệt?</h3>
              <p className="text-lg text-white/90 mb-6">
                Chúng tôi hỗ trợ sản xuất theo mã màu Pantone, RAL hoặc mẫu màu tùy chỉnh của bạn.
