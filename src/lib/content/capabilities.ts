/**
 * Capabilities & Services Content
 * Chứa nội dung về năng lực sản xuất và dịch vụ của công ty
 */

export const CAPABILITIES_SECTION = {
  title: "Năng lực và dịch vụ",
  subtitle: "Với cơ sở vật chất hiện đại và đội ngũ chuyên nghiệp, chúng tôi cam kết mang đến dịch vụ toàn diện từ sản xuất đến hậu mãi."
};
